...
namespace WebApplication1.Controllers
{
    ...
    {
        private readonly string _url = "https://localhost:7252/api/Compras";
        private readonly string _urlProductos = "https://localhost:7252/api/Productos";
        private readonly string _urlProveedor = "https://localhost:7252/api/Proveedors";
        private readonly string _urlCd = "https://localhost:7252/api/ComprasDetalle";
        //GET: CompraI
