...
namespace WebApplication1.Controllers
{
    ...
    {
        private readonly string _url = "https://localhost:7252/api/PacientesHabitaciones";
        private readonly string _urlHabitacionesDisponibles = "https://localhost:7252/api/Habitaciones/HabitacionesDisponibles";
