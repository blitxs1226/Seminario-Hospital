...
namespace WebApplication1.Controllers
{
    ...
    {
        private readonly string _urlRoles = "https://localhost:7252/api/Roles";
        private readonly string _urlAccesos = "https://localhost:7252/api/Access";
        private readonly string _urlAccesosRoles = "https://localhost:7252/api/AccessRoles";
